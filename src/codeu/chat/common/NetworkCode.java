...
public final class NetworkCode {
  ...
  public static final int
      ...
      GENERATE_USER_CLUSTERS_REQUEST = 31,
      GENERATE_USER_CLUSTERS_RESPONSE = 32,
      GET_RECOMMENDED_USERS_REQUEST = 33,
      GET_RECOMMENDED_USERS_RESPONSE = 34,
      ADD_USER_TO_CONVERSATION_REQUEST = 35,
      ADD_USER_TO_CONVERSATION_RESPONSE = 36,
      CHECK_EXISTENT_USERNAME_REQUEST = 37,
      CHECK_EXISTENT_USERNAME_RESPONSE = 38;
}
